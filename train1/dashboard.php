	...
	<body>
		<div class="sidebar close">
			...
			<div class="profile-content">
				...
				<div class="name-job username-link" onclick="openProfilePopup()">
				<div class="username">
					<?php echo htmlspecialchars($userDetails['username']); ?>
				</div>
				<div class="job" style="text-align:center; text-transform:capitalize;">
					<?php echo htmlspecialchars($userDetails['identity']); ?>
				</div>
				</div>
		  </li>
		</ul>
...
$pendingServiceRequests = $pdo->query("SELECT COUNT(*) FROM service_request WHERE status = 0")->fetchColumn();
