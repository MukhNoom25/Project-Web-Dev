...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["saveService"])) {
    ...
    $insertQuery = "INSERT INTO service_list (service, description, status) VALUES (:service, :description, :status)";
		  ...
		  <section class="home-section">
			...
			<div class="content">
				<div class="content-header">
					<h3 class="content-title">Add New Service</h3>
				</div>
                ...
                <div class="add-services-form">
                    <form action="" method="post">
                        ...
                        <div class="form-buttons">
                            <button type="submit" class="btn btn-flat btn-primary" name="saveService">Save</button>
