...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["updateServiceRequest"])) {
    ...
    $updateQuery = "UPDATE service_request SET train_type_id = :trainTypeId, train_brand = :trainBrand, train_registration_number = :trainRegistrationNumber, train_model = :trainModel, service_id = :serviceId, assigned_to_id = :assignedToId, status = :status WHERE request_id = :serviceRequestId";
