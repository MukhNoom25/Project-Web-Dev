...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO service_request (user_id, train_type_id, train_brand, train_registration_number, train_model, service_id, status) 
              VALUES (:userId, :trainTypeId, :trainBrand, :registrationNumber, :trainModel, :serviceId, :status)";
...
<body>
    ...
    <div class="background-container">
        ...
        <h2 class="center-title">Train Service Maintenance System For Maintenance Report Crew
